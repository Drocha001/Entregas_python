...
def borrar(br, tree):
    ...
    ######### BORRADO ####################
    borrar = tree.item(br).get("text")  # obtengo el id para buscar en l abase de datos
    con = conectar()
    cursor = con.cursor()
...
root = Tk()
root.title("probamos uso de base de datos")

titulo = Label(
    root,
    text=" Colocamos los valores para las funciones ",
    bg="blue",
    fg="white",
    height=1,
    width=60,
...
tree.grid(row=10, column=0, columnspan=15)
